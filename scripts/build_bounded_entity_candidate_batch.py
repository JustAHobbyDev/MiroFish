#!/usr/bin/env python3
"""
Build bounded entity candidates from bounded research sets.
"""
...
def main() -> int:
    ...
    parser.add_argument("research_set_batch_json", type=Path)
    parser.add_argument("--output-json", type=Path, required=True)
    args = parser.parse_args()

    module = _load_module("bounded_entity_candidate_builder")
    payload = module.build_bounded_entity_candidate_batch(
        json.loads(args.research_set_batch_json.read_text(encoding="utf-8"))
    )
