...
def main() -> None:
    ...
    accessibility_batch = json.loads(Path(args.public_market_us_accessibility_json).read_text(encoding="utf-8"))
    output = build_public_market_foreign_access_followup_batch(accessibility_batch)
