#!/usr/bin/env python3
"""
Build a deterministic trade-press prefilter batch from raw article records.
"""
...
def main() -> int:
    ...
    parser.add_argument("--batch-name", default="trade_press_prefilter_batch_v1")
    parser.add_argument("--output-json", type=Path, required=True)
    args = parser.parse_args()

    module = _load_module("trade_press_archive")
    payload = module.build_trade_press_prefilter_batch(
