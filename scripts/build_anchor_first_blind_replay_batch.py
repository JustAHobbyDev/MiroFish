#!/usr/bin/env python3
"""
Build an anchor-first replay artifact from historical prefilter batches.
"""
...
def main() -> int:
    ...
    parser.add_argument("--profile-name", default="photonics")
    ...
    module = _load_module("anchor_first_blind_replay_builder")
    payload = module.build_anchor_first_blind_replay_batch(
