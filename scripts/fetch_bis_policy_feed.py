#!/usr/bin/env python3
"""
Fetch live BIS updates and normalize them into policy-feed JSON.
"""
...
def main() -> int:
    ...
    _load_module("federal_register_relevance")
    feed_module = _load_module("bis_feed")
    payload = feed_module.fetch_bis_policy_feed(
