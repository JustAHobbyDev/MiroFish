#!/usr/bin/env python3
"""
Build deterministic energy-flow pressure clusters from a signal batch and its prefilter batch.
"""
...
def main() -> int:
    ...
    module = _load_module("energy_flow_pressure_clustering")
    payload = module.build_energy_flow_pressure_cluster_batch(
