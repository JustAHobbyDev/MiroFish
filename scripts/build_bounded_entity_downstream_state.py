#!/usr/bin/env python3
"""
Build consolidated bounded-entity downstream state.
"""
...
def main() -> None:
    ...
    parser.add_argument("followup_queue_json", help="Path to follow-up queue JSON.")
    ...
    parser.add_argument(
        "--output-name",
        default="bounded_entity_downstream_state_v1",
        help="Name to store inside the output batch.",
    )
    ...
    output = build_bounded_entity_downstream_state(
        queue_batch,
