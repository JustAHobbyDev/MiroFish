#!/usr/bin/env python3
"""
Build bounded-universe candidates from structural-pressure candidates.
"""
...
def main() -> int:
    ...
    parser.add_argument("structural_pressure_batch_json", type=Path)
    parser.add_argument("--output-json", type=Path, required=True)
    args = parser.parse_args()

    module = _load_module("bounded_universe_builder")
    payload = module.build_bounded_universe_candidate_batch(
        _load_json(args.structural_pressure_batch_json),
    )
