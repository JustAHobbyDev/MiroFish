#!/usr/bin/env python3
"""
Build the archive-backed photonics dependency graph artifact.
"""
...
def main() -> int:
    ...
    module = _load_module("photonics_dependency_graph_builder")
    payload = module.build_photonics_dependency_graph(_load_json(args.workflow_json))
