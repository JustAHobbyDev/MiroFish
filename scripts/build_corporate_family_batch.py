#!/usr/bin/env python3
"""
Build corporate-family candidates from bounded entity candidates.
"""
...
def main() -> int:
    ...
    parser.add_argument("bounded_entity_batch_json", type=Path)
    parser.add_argument("--output-json", type=Path, required=True)
    args = parser.parse_args()

    module = _load_module("corporate_family_normalizer")
    payload = module.build_corporate_family_batch(
        json.loads(args.bounded_entity_batch_json.read_text(encoding="utf-8"))
    )
