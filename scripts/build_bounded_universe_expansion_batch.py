#!/usr/bin/env python3
"""
Build bounded-universe expansion plans from bounded-universe candidates.
"""
...
def main() -> int:
    ...
    module = _load_module("bounded_universe_expander")
    payload = module.build_bounded_universe_expansion_batch(
