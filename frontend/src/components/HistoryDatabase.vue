        ...
        <div v-if="selectedProject" class="modal-overlay" @click.self="closeModal">
          <div class="modal-content">
            ...
            <div class="modal-divider">
              ...
              <span class="divider-text">{{ t('history.replay') }}</span>
              <span class="divider-line"></span>
            </div>
            ...
            <div class="modal-actions">
              ...
              >
                ...
                <span class="btn-text">{{ t('history.step1') }}</span>
              </button>
              <button 
              ...
              >
                ...
                <span class="btn-icon">◈</span>
                <span class="btn-text">{{ t('history.step2') }}</span>
              </button>
              <button 
              ...
              >
                ...
                <span class="btn-icon">◆</span>
                <span class="btn-text">{{ t('history.step4') }}</span>
              </button>
            </div>
            <!-- 不可回放提示 -->
...
const getSimulationTitle = (requirement) => {
  if (!requirement) return t('history.untitled')
