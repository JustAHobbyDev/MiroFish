        ...
        <div class="left-panel">
          ...
          <div class="metrics-row">
            <div class="metric-card">
              <div class="metric-value">{{ t('home.metrics.lowCostTitle') }}</div>
              <div class="metric-label">{{ t('home.metrics.lowCostLabel') }}</div>
            </div>
            <div class="metric-card">
              <div class="metric-value">{{ t('home.metrics.highScaleTitle') }}</div>
              <div class="metric-label">{{ t('home.metrics.highScaleLabel') }}</div>
            </div>
          </div>
          ...
          <div class="steps-container">
            ...
            <div class="workflow-list">
              <div v-for="(step, index) in workflowItems" :key="index" class="workflow-item">
          ...
          <div class="console-box">
            ...
            <div class="console-section">
              <div class="console-header">
                ...
                <span class="console-meta">{{ t('home.uploadFormats') }}</span>
              </div>
              ...
              >
                ...
                <div v-if="files.length === 0" class="upload-placeholder">
                  ...
                  <div class="upload-title">{{ t('home.dragTitle') }}</div>
                  <div class="upload-hint">{{ t('home.dragHint') }}</div>
                </div>
...
const workflowItems = computed(() => tm('home.workflow') || [])
