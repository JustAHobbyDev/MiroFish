...
当前仓库正在逐步从上游 fork 演化为独立的研究型产品，重点放在：

- 研究课题定义
- 实时政策 / 来源摄取
- `source_bundle` 与 `structural_parse` 构建
- claims audit / scorecards / mispricing workflow

这意味着：

- 上游血缘仍然重要
- 但上游不再是产品身份本身
- 后续同步将逐步转向“选择性 intake”，而不是默认追求 parity

相关文档：

- [项目身份说明](./docs/project-identity.md)
- [上游 Intake 策略](./docs/upstream-intake-policy.md)
- [README 重写提纲](./docs/readme-rewrite-outline.md)
- [重命名迁移清单](./docs/rename-migration-checklist.md)
...
但是否接收 upstream 变更，应以项目方向和维护价值为准。
