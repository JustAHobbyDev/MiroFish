"""
Deterministic consolidation of bounded-entity downstream state.
"""
    ...
    *,
    ...
    for row in followup_queue_batch.get("queue_rows", []):
        ...
        if private_plan:
            ...
            followup_status = "private_route_resolved"
        elif _coerce_string(support.get("filing_support_status")) == "supported":
